...
{
	m_preBarrierPtr.reset(new FlexBarrier(2));			// We need a barrier of 2 for exchanger.
	m_postBarrierPtr.reset(new FlexBarrier(2));			// We need two barriers to sync up the threads.
}
